...
async function proxyGuestPortal(path: string, init?: RequestInit): Promise<NextResponse> {
...
export async function GET(request: Request, { params }: Params) {
  ...
  return proxyGuestPortal(`/api/v1/public/guest-portal/${encodeURIComponent(token)}/${qs}`);
}

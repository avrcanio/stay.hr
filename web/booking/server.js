...
const APP_NAME = process.env.STAY_WEB_APP || "booking";
...
<html lang="en">
<head><meta charset="utf-8"><title>Stay.hr Booking</title></head>
<body>
  <h1>Stay.hr Booking</h1>
  <p>Host: <code>${host}</code></p>
  <p>Edge service is running. Full booking UI will be served here.</p>
</body>
</html>`);
});

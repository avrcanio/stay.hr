...
def rename_block_column_if_needed(apps, schema_editor):
    with schema_editor.connection.cursor() as cursor:
        cursor.execute(
            ...
            WHERE table_name = 'integrations_unitavailabilityblock'
              AND column_name = 'smoobu_booking_id'
            """
        )
        if cursor.fetchone():
            cursor.execute(
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(rename_block_column_if_needed, migrations.RunPython.noop),
